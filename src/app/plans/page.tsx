  ...
  return (
    <div className='flex flex-col items-center justify-start gap-8 self-stretch h-full pt-32'>
      ...
      <div className='flex flex-col items-center px-8 gap-6 '>
        ...
        <Link href='/' className='text-center text-sm font-light text-[#2B1EBB] hover:underline pb-14 md:text-lg'>Entre em contato e vamos personalizar um plano de acordo com a sua necessidade</Link>
      </div>
